import os
import argparse
from CoordDiffusion import convert_and_finetune_starcraft_model, sample_from_coord_model
...
def parse_args():
    ...
    parser.add_argument(
        "--model_path", 
        type=str, 
        default="coord_fine_tuned_models/starcraft_maps_coordconv/final",
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="coord_fine_tuned_models/starcraft_maps_coordconv",
...
def main():
    ...
    if args.mode == "train":
        ...
        trainer = convert_and_finetune_starcraft_model()
